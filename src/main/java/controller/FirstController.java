...
public class FirstController {
    ...
    public String hello(ModelMap map){
        List<Clients> list = service.list();
    ...
    public ModelAndView createNewForm(){
        ...
        modelAndView.getModelMap().addAttribute("newClient", new Clients());
        return modelAndView;
    }
    ...
    public ModelAndView createNewForm(@RequestParam int id){
        ...
        modelAndView.getModelMap().addAttribute("newClient", service.get(id));
        return modelAndView;
    }

    @RequestMapping(value = "/submitNew", method = RequestMethod.POST)
    public ModelAndView createNewAction(@ModelAttribute Clients newClient){
